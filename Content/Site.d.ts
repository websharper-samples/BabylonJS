...
declare module Site {
    ...
    module SceneLoading {
        var Main : {
            (container: __ABBREV.__Dom.Element): void;
        };
        var Sample : {
    ...
    module GlobalReferences {
        var op_BangBang : {
            <_M1>(a: __ABBREV.__WebSharper.ref<__ABBREV.__WebSharper.OptionProxy<_M1>>): _M1;
        };
        var initializeSample : {
            (container: __ABBREV.__Dom.Element, width: number, height: number): any;
        };
        var op_BangPlus : {
            (a: __ABBREV.__Samples.Sample): __ABBREV.__Samples.Set;
        };
        var canvas : {
            (): __ABBREV.__Dom.Element;
        };
        var engine : {
            (): __ABBREV.__WebSharper.ref<__ABBREV.__WebSharper.OptionProxy<__ABBREV.__Engine.T>>;
        };
        var scene : {
            (): __ABBREV.__WebSharper.ref<__ABBREV.__WebSharper.OptionProxy<__ABBREV.__Scene.T>>;
        };
    }
}
declare module __ABBREV {
    ...
    export import __List = IntelliFactory.WebSharper.List;
    export import __Dom = IntelliFactory.WebSharper.JavaScript.Dom;
    export import __Engine = IntelliFactory.WebSharper.BabylonJs.BABYLON.Engine;
    export import __Scene = IntelliFactory.WebSharper.BabylonJs.BABYLON.Scene;
}
