...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Site,GlobalReferences,Math,Samples,List,AnimatedTorus,Set,Cube,SceneLoading,Client,document,Option,Builder,T,Operators,Sample,window,Html,Client1,Tags,Operators1,Unchecked,Attr,jQuery,EventsPervasives,Seq;
 Runtime.Define(Global,{
  Site:{
   AnimatedTorus:{
   ...
   Samples:{
    ...
    Sample:Runtime.Class({
     Show:function()
     {
      ...
      sMain=window.document.getElementById("sample-main");
      sSide=window.document.getElementById("sample-side");
      Samples.Clear(sMain);
      Samples.Clear(sSide);
      ...
      {
       var matchValue,copy;
       matchValue=window.document.getElementById(s.Id);
       if(Unchecked.Equals(matchValue,null))
        {
         return null;
        }
    ...
    Set:Runtime.Class({
     Show:function()
     {
      ...
      {
       var samples,doc,select,navs,arg10;
       samples=s.$0;
       doc=window.document;
